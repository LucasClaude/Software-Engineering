...
//  Core Motion
//
//  Created by Lucas Claude on 2018-04-13.
//  Copyright © 2018 Lucas Claude. All rights reserved.
//
...
struct Colors {
    ...
    static let brightOrange     = UIColor(red: 255.0/255.0, green: 69.0/255.0, blue: 0.0/255.0, alpha: 1.0)
     static let transparent     = UIColor(red: 0/255.0, green: 0/255.0, blue: 0.0/255.0, alpha: 1.0)
    static let red              = UIColor(red: 255.0/255.0, green: 115.0/255.0, blue: 115.0/255.0, alpha: 1.0)
    static let maroon             = UIColor(red: 130.0/255.0, green: 0.0/255.0, blue: 0.0/255.0, alpha: 1.0)
